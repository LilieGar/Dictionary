...
public class Gemini {
    ...
    public static void main(String[] args) {
        // Значение транзитов Луны по знакам зодиака для Близнецов
        Map<String, String> moonTransit = new HashMap<String, String>();

        //добавление элементов в словарь: тразит - значение
        moonTransit.put("Луна в Овне", "Личные инициативы, поездки, занятия спортом");
        moonTransit.put("Луна в Тельце", "Изучение мира прекрасного, покупки");
        moonTransit.put("Луна в Близнецах", "Подвижность, разговорчивость, много контактов, общения");
        {
